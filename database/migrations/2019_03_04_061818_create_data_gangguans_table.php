...
class CreateDataGangguansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('data_gangguans', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->decimal('rsps',10,4)->nullable()->default(NULL);
    ...
    {
        Schema::dropIfExists('data_gangguans');
    }
}
